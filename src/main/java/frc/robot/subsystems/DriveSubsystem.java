...
public class DriveSubsystem extends SubsystemBase {
  ...
  /**
  * Returns the current gyro angle, reversed if the gyroIsReversed flag is true.
  *
  * @return The current gyro angle (in degrees).
  */
  public double getAngle() {
    double angle = m_navx.getAngle(); // Get the raw gyro angle
    return DriveConstants.kGyroReversed ? -angle : angle; // Reverse if the flag is true
  }
